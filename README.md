...
```bash
.
├── include/         # Заголовкові файли (.hpp)
├── src/             # Файли реалізації основної програми (.cpp)
├── images/          # Зображення для документації
├── Laba_5.cpp       # Простий варіант лабораторної роботи
├── bin/             # Директорія для скомпільованого файлу основної програми
├── build.bat        # Скрипт збірки для Windows
├── build.sh         # Скрипт збірки для Linux/macOS
└── CMakeLists.txt   # Файл конфігурації збірки CMake
```
